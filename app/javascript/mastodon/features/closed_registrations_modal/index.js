      ...
      closedRegistrationsMessage = (
        <p className='prose'>
          <FormattedMessage
            ...
            defaultMessage='Creating an account on {domain} is currently not possible, but please keep in mind that you do not need an account specifically on {domain} to use AllPeep.'
    ...
    return (
      <div className='modal-root__modal interaction-modal'>
        <div className='interaction-modal__lead'>
          <h3><FormattedMessage id='closed_registrations_modal.title' defaultMessage='Signing up on AllPeep' /></h3>
          <p>
            <FormattedMessage
              id='closed_registrations_modal.preamble'
              defaultMessage='AllPeep is decentralized, so no matter where you create your account, you may be able to interact with people in this community.'
            />
          </p>
        </div>
